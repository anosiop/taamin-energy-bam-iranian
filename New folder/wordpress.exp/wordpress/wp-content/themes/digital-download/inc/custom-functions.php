...
function digital_download_scripts(){
    ...
    if( get_theme_mod( 'ed_localgoogle_fonts',false ) && ! is_customize_preview() && ! is_admin() ){
        if ( get_theme_mod( 'ed_preload_local_fonts',false ) ) {
			digital_download_load_preload_local_fonts( digital_download_get_webfont_url( digital_download_fonts_url() ) );
        }
        wp_enqueue_style( 'digital-download-google-fonts', digital_download_get_webfont_url( digital_download_fonts_url() ) );
    }else{
...
if( ! function_exists( 'digital_download_block_editor_styles' ) ) :
    /**
     * Enqueue editor styles for Gutenberg
     */
    function digital_download_block_editor_styles() {
    
    // Block styles.
    wp_enqueue_style( 'digital-download-block-editor-style', get_template_directory_uri() . '/inc/css/editor-block.css' );
...
add_action( 'enqueue_block_editor_assets', 'digital_download_block_editor_styles' );
