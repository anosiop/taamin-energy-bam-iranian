...
?>
  <div class="container-fluid mr-bot40 mg-posts-sec-inner">
        ...
        <div class="row">
            <?php $you_missed_title = get_theme_mod('you_missed_title', esc_html('You missed','newspaperex'));
            if($you_missed_title) { ?>
            <div class="col-md-12">
                    ...
                    <div class="container-fluid">
                        <div class="row">
                          <?php $newsup_enable_footer_menu = esc_attr(get_theme_mod('newsup_enable_footer_menu','true'));
                            ...
                            <?php } ?>
                                <p>
                                <a href="<?php echo esc_url( __( 'https://wordpress.org/', 'newspaperex' ) ); ?>">
								<?php
								/* translators: placeholder replaced with string */
								printf( esc_html__( 'Proudly powered by %s', 'newspaperex' ), 'WordPress' );
								?>
								</a>
								<span class="sep"> | </span>
								<?php
								/* translators: placeholder replaced with string */
								printf( esc_html__( 'Theme: %1$s by %2$s.', 'newspaperex' ), 'Newspaperex', '<a href="' . esc_url( __( 'https://themeansar.com/', 'newspaperex' ) ) . '" rel="designer">Themeansar</a>' );
								?>
								</p>
                            </div> 
